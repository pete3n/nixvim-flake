...
## STATUS - Currently dogfooding 24.11/unstable in-progress

I have updated/refactored this config to support different branches, going forward
the structure will be:

- main (unstable)
- nixos-24.11 (current)
- nixos-23.11 (previous, not maintained)
